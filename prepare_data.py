...
def prepare_data(dataset_name,k):
    train_txt=open('./data/corpus/'+dataset_name+'.train.txt','r').readlines()
    train_seqs=[]
    for line in train_txt:
        train_seqs.append(line.strip())

    test_txt=open('./data/corpus/'+dataset_name+'.test.txt','r').readlines()
    test_seqs=[]
    ...
    print(n_test)
    train_labels_txt=open('./data/corpus/'+dataset_name+'.train.label','r').readlines()
    train_labels=[]
    for line in train_labels_txt:
        train_labels.append(line.strip())

    test_labels_txt=open('./data/corpus/'+dataset_name+'.test.label','r').readlines()
    test_labels=[]
